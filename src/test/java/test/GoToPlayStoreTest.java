...
import pageobject.AndroidStorePage;
 ...
 *
 */
public class GoToPlayStoreTest extends TestSetConfig{
	...
	public void goToPlayStoreTest() {
		...
		ourApps.clickOnAndroidStoreButton();
		
		AndroidStorePage androidStore = new AndroidStorePage(getDriver());
		
		//We only check if the app is Voicemod
		androidStore.waitVoicemodAndoridAppIsVisible();
		Assert.assertTrue(androidStore.checkVoicemodAndoridAppIsVisible(), "The app shown is not Voicemod");
